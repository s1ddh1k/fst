...
// Match backtester defaults: 0.025% fee (Upbit coupon rate), 0.05% slippage
export const PAPER_FEE_RATE = Number.parseFloat(process.env.PAPER_FEE_RATE ?? "0.00025");
export const PAPER_SLIPPAGE_RATE = Number.parseFloat(process.env.PAPER_SLIPPAGE_RATE ?? "0.0005");
